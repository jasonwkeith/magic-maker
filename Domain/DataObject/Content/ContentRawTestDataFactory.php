...
class ContentRawTestDataFactory implements ContentRawTestDataFactoryInterface
{
    public function __construct( HistoryTestDataFactoryInterface $history_test_data_factory )
    {
        ...
        $this->dto[ 1 ]->history = $this->history_test_data_factory->create( 0 );            
        ...
        $this->dto[ 2 ]->history = $this->history_test_data_factory->create( 0 );            
        $this->dto[ 2 ]->text = "Test Content 2";

        $this->dto[ 3 ] = new ContentDataTransferObject;
        $this->dto[ 3 ]->history = $this->history_test_data_factory->create( 0 );            
        ...
        $this->dto[ 4 ]->history = $this->history_test_data_factory->create( 0 );            
        ...
        $this->dto[ 5 ]->history = $this->history_test_data_factory->create( 0 );            
        ...
        $this->dto[ 6 ]->history = $this->history_test_data_factory->create( 0 );            
        ...
        $this->dto[ 7 ]->history = $this->history_test_data_factory->create( 0 );            
        ...
        $this->dto[ 8 ]->history = $this->history_test_data_factory->create( 0 );            
        ...
        $this->dto[ 9 ]->history = $this->history_test_data_factory->create( 0 );            
